# dash-select-material

A selects component for plotly dash with material theme
...
5. Find source files
  ...
  - Navigate to `webpack:// -> [your/repo/path]] -> dash-select-material -> src` to find your component source files.
...
3. Run the dash layout you want to test
        ...
        # Import dash-select-material to your layout, then run it:
